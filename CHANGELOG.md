...
## [event-2026-06-30] - 2026-06-30

Released:

- `@tagline-sh/bot@0.4.1` — see [apps/bot/CHANGELOG.md](apps/bot/CHANGELOG.md)

## [event-2026-06-29] - 2026-06-29

Released:

- `@tagline-sh/bot@0.4.0` — see [apps/bot/CHANGELOG.md](apps/bot/CHANGELOG.md)

## [event-2026-06-29] - 2026-06-29

Released:

- `@tagline-sh/bot@0.3.2` — see [apps/bot/CHANGELOG.md](apps/bot/CHANGELOG.md)
- `@tagline-sh/shared@0.1.1` — see [packages/shared/CHANGELOG.md](packages/shared/CHANGELOG.md)
...
- `@tagline-sh/action@0.1.0` — see [apps/action/CHANGELOG.md](apps/action/CHANGELOG.md)
- `@tagline-sh/bot@0.1.0` — see [apps/bot/CHANGELOG.md](apps/bot/CHANGELOG.md)
- `@tagline-sh/shared@0.1.0` — see [packages/shared/CHANGELOG.md](packages/shared/CHANGELOG.md)
